...
if FLAGS.glove_pretrained_dataset == '6B':
    ...
    GLOVE_EMBEDDING_ZIP_PATH = GLOVE_DIR + GLOVE_EMBEDDING_FILE_NAME + '.zip'
else:
    GLOVE_EMBEDDING_FILE_NAME = 'glove.840B.300d'
    GLOVE_EMBEDDING_FILE_PATH = GLOVE_DIR + GLOVE_EMBEDDING_FILE_NAME + '.txt'
    GLOVE_EMBEDDING_ZIP_PATH = GLOVE_DIR + GLOVE_EMBEDDING_FILE_NAME + '.zip'

FASTTEXT_EMBEDDING_FILE_PATH = FASTTEXT_DIR + 'crawl-300d-2M.vec'
FASTTEXT_EMBEDDING_ZIP_PATH = FASTTEXT_DIR + 'crawl-300d-2M.vec.zip'
FINETUNED_GLOVE_EMBEDDING_FILE_PATH = GLOVE_DIR + 'finetuned_glove.300d.txt'
TRAINED_GLOVE_EMBEDDING_FILE_PATH = GLOVE_DIR + 'trained_glove.300d.txt'
